...
class Client extends BaseClient {
  ...
  constructor(options) {
    ...
    /**
     * A markov chain object
     * @type {Markov}
     */
    this.markov = new Markov();

    /**
     * This boolean is used to verify that the markov object has been trained
     * @type {boolean}
     */
    this.isTrained = false;

    /**
     * This boolean is used to verify that the markov object has states
     * @type {boolean}
     */
